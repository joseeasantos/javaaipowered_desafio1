...
RESTful API resultante do desafio de código da aula [Publicando Sua API REST na Nuvem Usando Spring Boot 3, Java 17 e Railway](https://web.dio.me/project/publicando-sua-api-rest-na-nuvem-usando-spring-boot-3-java-17-e-railway/learning/138c435a-5be5-450b-a292-cf6ea002f54c) 
baseado no projeto desenvolvido pelo [Venilton FalvoJr](https://github.com/falvojr) em Santander Dev Week 2023. Construída em Java 17 com Spring Boot 3.
...
```
## Docker
Para baixar a imagem Docker para o projeto e subir o banco Postgres, execute o arquivo "executarDockerDev.bat". 
